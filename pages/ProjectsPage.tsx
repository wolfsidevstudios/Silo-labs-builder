...
const ProjectsPage: React.FC<ProjectsPageProps> = ({ onLoadProject }) => {
  ...
  const openDeleteModal = (project: SavedProject, e: React.MouseEvent) => {
  ...
  return (
    <>
      <DeleteProjectModal
        ...
        projectName={projectToDelete?.name || projectToDelete?.prompt || ''}
      />
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex flex-col justify-end p-4 bg-gradient-to-t from-black/80 via-black/50 to-transparent">
                          <button
                            ...
                            className="absolute top-3 right-3 z-10 p-2 bg-slate-800/50 rounded-full text-slate-400 hover:bg-red-500/50 hover:text-white opacity-0 group-hover:opacity-100 transition-all"
