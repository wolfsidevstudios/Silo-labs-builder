...
const GitHubSaveModal: React.FC<GitHubSaveModalProps> = ({ isOpen, onClose, onSave, isNewRepo }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative overflow-hidden bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8 m-4 max-w-lg w-full transform transition-transform duration-300 scale-95 animate-scale-in"
